import { generateCaveGrid } from '../generators/CaveGenerator';
...
/** Receives a generation request, runs the cave generator, and posts the result.
...
self.onmessage = (e: MessageEvent<WorkerRequest>) => {
  ...
  const result = generateCaveGrid(seed, width, height, preferDiagonal);
